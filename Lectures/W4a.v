...
Proof.
  ...
  injection H1 as Hx Hj.
  rewrite Hx. rewrite <- Hj.
  intros H2. injection H2 as Hy.
  symmetry.
  apply Hy.
Qed.
...
- Used to instantiate a universally quantified variable in a hypothesis
...
Proof. intros n. induction n as [| n' IHn'].
  ...
  - intros m H. destruct m as [| m'].
    + simpl in H. discriminate H.
    + simpl. rewrite <- plus_n_Sm. simpl in H.  rewrite IHn'.
      ++ reflexivity.
      ++ apply H.
Qed.
